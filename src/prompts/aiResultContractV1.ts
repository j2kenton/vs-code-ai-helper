...
const CONTENT_TYPE_SHAPE_HINTS_V1: Readonly<Record<CompletedContentTypeNameV1, string>> = {
  ...
  "preflight-plan.v1":
    ...
    // Optional, and stated here because the session preamble asks for it: a
    // plan whose only flaw was carrying this field was rejected whole on
    // 2026-09-18 (see PreflightPlanCompletedV1.reasoning). Naming it in the
    // contract is what makes asking for it honest.
    '"reasoning":"<optional prose: why this slice, and what remains>"}',
  "edit-execution.v1":
