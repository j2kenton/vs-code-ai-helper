...
> = {
  ...
  watchdogPauseClaimId: {
    migration: "Validate bounded non-empty string/current optionality; absent on new tasks and on any pause not committed through the pauseCommit claim protocol.",
    nextStage: "Clear — parity with pausedReason, which it is always cleared alongside.",
    markTaskDone: "Clear.",
    reopen: "Clear — parity with pausedReason.",
  },
  watchdogPauseFenceGeneration: {
    migration: "Validate non-negative integer/current optionality; absent on new tasks, on any pause not committed through the pauseCommit claim protocol, and on a claim-bound pause committed before this field existed (Part 1a builds).",
    nextStage: "Clear — parity with watchdogPauseClaimId, which it is always cleared alongside.",
    markTaskDone: "Clear.",
    reopen: "Clear — parity with watchdogPauseClaimId.",
  },
  lintPayload: {
