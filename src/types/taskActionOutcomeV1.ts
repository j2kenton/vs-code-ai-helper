...
export type TaskActionOutcomeV1 =
  ...
  | {
       ...
       * schema contracts — never provider/model output — so it does not weaken
       * §2.2/§3.7's sanitized-outcome rule. Optional and additive: every
       * existing malformedResult outcome (and every persisted record without
       * it) remains valid.
       */
