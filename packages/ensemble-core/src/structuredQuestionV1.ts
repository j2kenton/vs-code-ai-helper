 ...
 * branded return values"). Kept byte-identical to the extension's copy in
 * `src/types/structuredQuestionV1.ts`.
 */
 ...
 * never itself be mistaken for either public decoder's result. Kept
 * byte-identical to the extension's copy in `src/types/structuredQuestionV1.ts`.
 */
 ...
 * closed) would silently override the app's own policy. Kept byte-identical
 * to the extension's copy in `src/types/structuredQuestionV1.ts`.
 *
