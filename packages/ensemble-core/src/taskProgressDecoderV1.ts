/**
 * Strict task-progress decoder and version selector (Part 2 port of
 * `src/services/taskProgressDecoderV1.ts`; original commentary retained).
 *
...
import { decodeFallbackStateV1 } from "./fallbackStateV1";
...
// (adds "review"); kept as a separate set, mirroring src/services/
// taskProgressDecoderV1.ts, so roundOutcomes.dispatchMode and
// implRecovery.sourceDispatchMode (genuinely implementation-only) keep
// rejecting "review".
